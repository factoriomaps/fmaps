...
FOLDERS=("${ASSET_PATH}/js/browse/${BROWSE_VERSION}/" "${ASSET_PATH}/js/leaflet/edit/${CURRENT_VERSION}/" "${ASSET_PATH}/js/leaflet/map/${CURRENT_VERSION}/" "${ASSET_PATH}/js/nav/${CURRENT_VERSION}/" "${ASSET_PATH}/css/browse/${CURRENT_VERSION}/" "${ASSET_PATH}/css/leaflet/edit/${CURRENT_VERSION}/" "${ASSET_PATH}/css/leaflet/map/${CURRENT_VERSION}/" "${ASSET_PATH}/css/nav/${CURRENT_VERSION}/")

for p in "${FOLDERS[@]}"; do
    [ ! -d "${p}" ] && mkdir -p "${p}"
done

uglifyjs src/js/browse/main.js -m > "${ASSET_PATH}/js/browse/${BROWSE_VERSION}/browse.js"
