...
FOLDERS=("${ASSET_PATH}/js/browse/${CURRENT_VERSION}/" "${ASSET_PATH}/js/leaflet/edit/${CURRENT_VERSION}/" "${ASSET_PATH}/js/leaflet/map/${CURRENT_VERSION}/" "${ASSET_PATH}/css/browse/${CURRENT_VERSION}/" "${ASSET_PATH}/css/leaflet/edit/${CURRENT_VERSION}/" "${ASSET_PATH}/css/leaflet/map/${CURRENT_VERSION}/")
